...
Вот готовый блок для твоего файла `команды.md`. Можешь просто **дописать** его в тот же файл через кнопку Edit (карандашик) на GitHub.

Вот кусок, который добавляем после раздела "Быстрые команды":
